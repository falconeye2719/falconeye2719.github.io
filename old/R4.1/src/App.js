...
                if (gradient <= 5) {
                    gradientBasedPenaltyPercentage = 0.02; // 2%遅くする
                } else if (gradient <= 10) {
                    gradientBasedPenaltyPercentage = 0.05; // 5%遅くする
                } else if (gradient <= 15) {
                    gradientBasedPenaltyPercentage = 0.08; // 8%遅くする
                } else {
                    gradientBasedPenaltyPercentage = 0.10; // 10%遅くする
                }
            } else if (gradient < -5) { // 下り坂
                if (gradient <= -15) {
                    gradientBasedPenaltyPercentage = -0.10; // 10%速くする
                } else if (gradient <= -10) {
                    gradientBasedPenaltyPercentage = -0.07; // 7%速くする
