...
const formatTime = (milliseconds) => {
    ...
    return `<span class="math-inline">\{totalHours\.toString\(\)\.padStart\(2, '0'\)\}\:</span>{minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`;
};
...
    console.log('handleSimulate 後の startTime:', startTime);
